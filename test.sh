...
# assert 5 'int main(){ int x; x=3; y=5; return *(&x+8); }'
# assert 3 'int main(){ int x; x=3; y=5; return *(&y-8); }'
# assert 7 'int main(){ int x; x=3; y=5; *(&x+8)=7; return y; }'
# assert 7 'int main(){ int x; x=3; y=5; *(&y-8)=7; return x; }'
echo OK