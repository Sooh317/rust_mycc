...
assert_func 'foo2(3, 4);'
assert_func 'a = 5; b = 6; c = a * b; foo3(a, b, c);'
assert_func 'a = 5; b = 6; foo3(a, a * b, - a * b);'
assert_func 'a = 5; b = 6; foo4(a + b, a - b, a * b, - a * b);'
assert_func 'a = 5; b = 6; c = 100; foo5(a + b, c + -c + c + -c + c, a * b, b * c, c * a);'
